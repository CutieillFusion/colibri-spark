"""Make Ray worker rank placement deterministic across cluster restarts."""
...
def apply():
    """Order Ray placement bundles by the configured rank-to-IP mapping."""
